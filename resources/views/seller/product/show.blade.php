...
<div class="card-header d-flex justify-content-between mt-3 mx-2">
    ...
    <div>
        <a href="{{ route('seller.product.inactive', $product->id) }}" id="delete" class="btn btn-danger btn-sm">Delete Product</a>
    </div>
</div>
                    ...
                    <div class="my-5 mx-xl-10">
                        ...
                        <div class="mb-4">
                            ...
                            <div>
                                ...
                                <div class="my-3">
                                    <a href="{{ route('seller.product.review', $product->id) }}" class="btn-link fw-semi-bold ">View all {{ $review_count }} reviews</a>
                                </div>
                            </div>
                        </div>
                    </div>
